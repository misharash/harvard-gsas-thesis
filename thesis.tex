...
% However, this package may produce awkward effects in the PDF contents/bookmarks
% and confuse the handy cleveref package
...
% acknowledments are optional. Comment out whatever you don't like
\listoftables
\listoffigures
...
% Alternatively, one can number the intro chapter
% Not numbering it does not seem to be among the formatting requirements (2025)
% If you want to number sections within the introduction, you probably should
% let the introduction be Chapter 1 (otherwise these sections will be 0.X)
% \chapter{Introduction}
\label{ch:intro}
\input{intro}

% \texorpdfstring{#1}{#2} allows to remove/change certain parts in the PDF
% bookmarks/table of contents, often handy for math, but also footnotes
% like here
